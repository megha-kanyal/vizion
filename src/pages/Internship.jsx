...
//               <Link to="/ifilters" className="bg-teal-500 text-white px-4 py-2 rounded-md">Add Events</Link>
    ...
    <div className="flex flex-col md:flex-row min-h-screen bg-gray-50">
      ...
      <div className="flex-1 p-6">
        <div className="flex justify-between items-center mb-6">
          ...
          <div className="">
            <span className="bg-blue-500 mx-3 text-white px-3 py-1 rounded-full text-sm">
              {filteredInternships.length} Internships Found
            </span>
            {/* button link */}
            <Link to="/add-internship" className="bg-blue-500 text-white px-4 py-2 rounded-md">
              Post Internship
            </Link>
          </div>
        </div>
            ...
            filteredInternships.map((internship) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <button className="w-full bg-blue-500 hover:bg-blue-600 text-white font-medium py-2 px-4 rounded-md transition-colors duration-300 flex items-center justify-center">
                    Apply Now
                  </button>
                </div>
              </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-screen overflow-auto">
            ...
            <div className="p-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div className="flex items-start">
                  <Briefcase className="w-5 h-5 mr-3 text-blue-500 mt-1" />
                  <div>
                ...
                <div className="flex items-start">
                  <DollarSign className="w-5 h-5 mr-3 text-blue-500 mt-1" />
                  <div>
              ...
              <div className="flex flex-col sm:flex-row gap-4"> 
                <button className="flex-1 bg-blue-500 hover:bg-blue-600 text-white font-medium py-3 px-6 rounded-md transition-colors duration-300">
                  Apply Now
                </button>
                <button className="flex-1 border border-blue-500 text-blue-500 hover:bg-blue-50 font-medium py-3 px-6 rounded-md transition-colors duration-300">
                  Save for Later
                </button>
              </div>
            </div>
